...
for nitem = 0, reaper.CountSelectedMediaItems(0) -1 do
  ...
  final_itemend = trim_left_destination(itemend); if not final_itemend then final_itemend = 0 end
  reaper.SetMediaItemInfo_Value(item, 'D_LENGTH', final_itemend-itemstart) 
end
---- Move View ----
