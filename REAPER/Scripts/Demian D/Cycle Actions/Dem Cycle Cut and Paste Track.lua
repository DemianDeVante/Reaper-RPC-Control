...
stage = tonumber(reaper.GetExtState('DemCycleCutPasteTrack', 'sstage')) or stagedefault
if stage == 1 then
  reaper.Main_OnCommand(40337,0)
  reaper.SetExtState('DemCycleCutPasteTrack', 'sstage', 2, false)
end
if stage == 2 then
  reaper.Main_OnCommand(42398,0)
  reaper.SetExtState('DemCycleCutPasteTrack', 'sstage', 1, false)
end
reaper.Undo_EndBlock( "Cycle Cut and Paste Track", -1)
