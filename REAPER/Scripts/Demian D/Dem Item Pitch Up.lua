...
newvalue = 0.1 -- set the value to add
item_count = reaper.CountSelectedMediaItems( 0 )
for nitem = 0, item_count -1 do
 selitem = reaper.GetSelectedMediaItem( 0, nitem )
 take = reaper.GetActiveTake( selitem )
 pitch_value = reaper.GetMediaItemTakeInfo_Value( take, "D_PITCH")
 reaper.SetMediaItemTakeInfo_Value( take, "D_PITCH", pitch_value + newvalue )
