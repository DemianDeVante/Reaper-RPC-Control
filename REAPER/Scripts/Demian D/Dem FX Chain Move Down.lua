...
---------- Move to Next FX in Chain --------------------------------------------
if track then
    if (fxnumber < (fxcount -1)) or (fxnumber > (fxcount -1) and fxnumber < (16777216 + fxcount -1)) then
      reaper.TrackFX_CopyToTrack( track, fxnumber, track, fxnumber +1, 1 )
      reaper.TrackFX_Show( track, fxnumber +1 , 1 )
    end
elseif take then
    if (fxnumber < (fxcount -1)) then
      reaper.TakeFX_CopyToTake( take, fxnumber, take, fxnumber +1, 1 )
